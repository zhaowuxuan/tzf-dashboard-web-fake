      ...
      <b-row>
        <b-col xl="8" class="mb-5 mb-xl-0">
          <card type="default" header-classes="bg-transparent">
            ...
            <div id = "maincontainer" height="350">
            </div>
          </card>
        </b-col>
  ...
  export default {
    ...
    methods: {
      initBigChart(index) {
        ...
        maincontainer.style.width = document.getElementById('maincontainer').style.width + 'px';
        maincontainer.style.height = document.getElementById('maincontainer').style.height + 'px';
