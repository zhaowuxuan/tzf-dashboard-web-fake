  ...
  export default {
    ...
    methods: {
      ...
      initContainer(){
        ...
        this.allChart.bubbleContainer = document.getElementById('bubblechart-container');
        this.allChart.cumulativeContainer = document.getElementById('cumulativechart-container');
        this.allChart.keywordsContainer = document.getElementById('keywordschart-container');
      },
      initMyChart(container,data,index){
        var timeData = this.allChart.allData.date;
        ...
        if (index == 0){
          ...
          delete option.yAxis[1];
          delete option.series[0];
          delete option.series[1].name;
        }else if(index == 2){
          delete option.legend;
          delete option.yAxis[0].name;
          delete option.yAxis[1];
    ...
    mounted() {
      this.initData();
      this.initContainer();
      this.initMyChart(this.allChart.priceContainer,this.allChart.allData.price,0);
      this.initMyChart(this.allChart.bubbleContainer,this.allChart.allData.bubble,1);
      this.initMyChart(this.allChart.cumulativeContainer,this.allChart.allData.growth_60_day,2);
      this.initMyChart(this.allChart.keywordsContainer,this.allChart.allData.hot,3);
    }
  };
